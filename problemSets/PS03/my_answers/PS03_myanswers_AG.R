...
plot(incumbent$difflog, incumbent$voteshare, 
     main='Relationship between incumbent voteshare and difference in 
     campaign spending',
...
#1d) Write the prediction equation (this is explained further in the PDF)
...
# 2d) Write the prediction equation
# Pres vote = 0.508 + 0.024 * difflog

# Q3
# 3a) Running a regression with voteshare as outcome variable and presvote as explanatory variable
...
# 3b) Making a scatterplot with the two variables and adding a regression line
...
# 3d) Prediction equation
# Vote share = 0.441 + 0.388 * Pres vote
...
# 4c) Prediction equation
# Q1 Residuals = -5.934e-18 + 0.257 * Q2 residuals

# Q5
# 5a) I run a multiple linear regression model with 
# incumbent's voteshare as the outcome variable
# and difflog and presvote as the two explanatory variables
